...
public:
  ...
  vector<unique_ptr<Expression>> &condition_expressions() { return condition_expressions_; }
...
private:
  ...
  vector<unique_ptr<Expression>> condition_expressions_;  ///< WHERE条件表达式（支持算术表达式）
